...
public class TimelyReceiver implements ReceiveStreamListener, SessionListener,
        ControllerListener {
    ...
    public TimelyReceiver(String sessions[]) {
    ...
    public static void main(String argv[]) {
        String[] strs = { "121.48.195.152/9994", "121.48.195.152/9996" };
        TimelyReceiver avReceive = new TimelyReceiver(strs);
